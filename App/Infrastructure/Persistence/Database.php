...
class Database
{
    public static function initializer(PDO $connection)
    {
        ...
        $connection->exec(" INSERT INTO book (title, section, isbn, author, amount_of_books) VALUES ('Book Title 1', 1, '123-4567890123', 'Author 1', 5), ('Book Title 2', 2, '987-6543210987', 'Author 2', 3); ");
    }
}
